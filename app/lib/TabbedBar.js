...
module.exports = (function () {
    ...
    switch (Ti.Platform.name) {
        ...
        return {
            createTabbedBar: function (options) {
                return options.multiple ? createBar(options) : Ti.UI.iOS.createTabbedBar(options);
            }
        };
        break;
        default: //e.g. android
    ...
    function createBar(options) {
        ...
        options.barBorderWidth ? barBorderWidth = options.barBorderWidth : barBorderWidth = 1;
